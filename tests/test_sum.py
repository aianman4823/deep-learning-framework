...
class TestSum(unittest.TestCase):
    ...
    def test_backward1(self):
        ...
        def f(x): return F.sum(x)
        self.assertTrue(gradient_check(f, x_data))

    def test_backward2(self):
        x_data = np.random.rand(10, 10)
        def f(x): return F.sum(x, axis=1)
        self.assertTrue(gradient_check(f, x_data))

    def test_backward3(self):
        x_data = np.random.rand(10, 20, 20)
        def f(x): return F.sum(x, axis=2)
        self.assertTrue(gradient_check(f, x_data))

    def test_backward4(self):
        x_data = np.random.rand(10, 20, 20)
        def f(x): return F.sum(x, axis=None)
        self.assertTrue(gradient_check(f, x_data))
...
class TestSumTo(unittest.TestCase):
    ...
    def test_backward1(self):
        x_data = np.random.rand(10)
        def f(x): return F.sum_to(x, (1,))
        self.assertTrue(gradient_check(f, x_data))

    def test_backward2(self):
        x_data = np.random.rand(10, 10) * 10
        def f(x): return F.sum_to(x, (10,))
        self.assertTrue(gradient_check(f, x_data))
    ...
    def test_backward4(self):
        x_data = np.random.rand(10)
        def f(x): return F.sum_to(x, (10,)) + 1
        self.assertTrue(gradient_check(f, x_data))
